...
export default async function HomePage() {
  ...
  return (
    <div className="md:pl-11">
      <div className="fixed top-0 bottom-0 left-0 z-40 hidden w-11 items-start justify-center border-r-2 border-ink bg-paper pt-5 md:flex">
        <span className="text-[13px] font-black tracking-[0.34em] text-muted [writing-mode:vertical-rl]">
          設計課程 ・ 路上觀察
        </span>
      </div>
